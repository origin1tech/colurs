...
let _browser = false;
const _dotExp = /\./g;
const _stripExp = /[\u001b\u009b][[()#;?]*(?:[0-9]{1,4}(?:;[0-9]{0,4})*)?[0-9A-ORZcf-nqry=><]/g;
...
class Colurs implements IColurs {

  Colurs: IColursInstance = Colurs;
  ...
  private start(style: string): string {
    return style ? `\x1B[${this.options.ansiStyles[style][0]}m` : '';
  }
